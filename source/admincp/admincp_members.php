 ...
 *
 *      $Id: admincp_members.php 31552 2012-09-07 08:11:32Z zhengqingpeng $
 */
		...
		if($operation == 'reward') {
			...
			if(!empty($updatesql)) {
				...
				for($i=0; $i > -1; $i++) {
					...
					DB::query("UPDATE ".DB::table('common_member_count')." SET uid=uid $updatesql WHERE uid IN ($uids_conditions)", 'UNBUFFERED');
